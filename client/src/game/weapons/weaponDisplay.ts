...
const META: Record<string, { label: string; type: string; icon: string; slot: string }> = {
  ...
  ssg: { label: "SSG Scout", type: "Sniper Rifle", icon: "🔭", slot: "1" },
  aug: { label: "AUG", type: "Assault Rifle", icon: "🎯", slot: "1" },
  ...
  fiveseven: { label: "Five-SeveN", type: "Pistol", icon: "🔫", slot: "2" },
  knife: { label: "Karambit Ganda", type: "Melee", icon: "🔪", slot: "3" },
  combatknife: { label: "Karambit Taktis", type: "Melee", icon: "🔪", slot: "3" },
